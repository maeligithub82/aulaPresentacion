...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mc_biolo1}", "click", function(sym, e) {
         window.location.href = "ciencias/biologia/contenidos/bloque1/comparacion_seres_vivos.html";
      ...
      Symbol.bindElementAction(compId, symbolName, "${_icono_portal3}", "click", function(sym, e) {
