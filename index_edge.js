...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'taller',
            type:'image',
            rect:['50px','474px','300px','148px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"taller.png",'0px','0px']
         },
         {
            id:'icono_prese',
            type:'image',
            rect:['670px','474px','300px','148px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"icono_prese.png",'0px','0px']
         },
         {
            id:'icono_portal3',
            type:'image',
            rect:['361px','474px','300px','148px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid365", tween: [ "style", "${_taller}", "opacity", '1', { fromValue: '0'}], position: 500, duration: 500 },
            ...
            { id: "eid357", tween: [ "style", "${_taller}", "left", '13px', { fromValue: '48px'}], position: 500, duration: 110 },
            { id: "eid353", tween: [ "style", "${_taller}", "left", '50px', { fromValue: '13px'}], position: 610, duration: 390 },
            ...
            { id: "eid363", tween: [ "style", "${_icono_prese}", "opacity", '1', { fromValue: '0'}], position: 500, duration: 500 },
            { id: "eid372", tween: [ "style", "${_icono_portal3}", "left", '323px', { fromValue: '357px'}], position: 500, duration: 110 },
            { id: "eid370", tween: [ "style", "${_icono_portal3}", "left", '361px', { fromValue: '323px'}], position: 610, duration: 390 },
            ...
            { id: "eid355", tween: [ "style", "${_icono_prese}", "left", '633px', { fromValue: '668px'}], position: 500, duration: 110 },
            { id: "eid351", tween: [ "style", "${_icono_prese}", "left", '670px', { fromValue: '633px'}], position: 610, duration: 390 },
            ...
            { id: "eid374", tween: [ "style", "${_icono_portal3}", "opacity", '1', { fromValue: '0'}], position: 500, duration: 500 },
